  ...
  const [projects] = useState([
    ...
    },
    {
      ...
      description:
        'Helping bar owners to quickly deplete kegs from leftover product, while helping avid beer drinkers find less expensive ways to drink with friends.',
      tools: 'Sequelize/Express/Node/Handlebars',
      github: 'https://github.com/JoshCarter8400/book-search-engine',
      demo: 'https://salty-mesa-30136.herokuapp.com/',
      icon1: <AiOutlineEye />,
      icon2: <AiFillGithub />,
    },
    {
      ...
      description:
        'Helping bar owners to quickly deplete kegs from leftover product, while helping avid beer drinkers find less expensive ways to drink with friends.',
      tools: 'Sequelize/Express/Node/Handlebars',
      github: 'https://github.com/JoshCarter8400/note-taker',
      demo: 'https://note-taker-joshc.herokuapp.com/',
      icon1: <AiOutlineEye />,
      icon2: <AiFillGithub />,
    },
    {
